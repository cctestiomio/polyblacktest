...
Out-File -FilePath $trackerPath -InputObject $newTrackerCode -Encoding utf8
Write-Host "Success! tracker.py has been updated for universal market tracking." -ForegroundColor Green
Write-Host "You can now run:" -ForegroundColor Cyan
Write-Host "python tracker.py https://polymarket.com/sports/league-of-legends/lol-fly-ly-2026-02-21" -ForegroundColor Yellow